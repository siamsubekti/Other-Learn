    ...
    <Grid className={classes.root}>
      ...
      >
        ...
        <List>
          ...
          <Link className="" to="/listminum">
            <ListItem button >
              <ListItemIcon><LocalBarIcon /></ListItemIcon>
              <ListItemText>Baverage List</ListItemText>
            </ListItem>
          </Link>
          ...
          <Link className="" to="/bookmeja">
            <ListItem button >
              ...
              <ListItemText>Table Book</ListItemText>
            </ListItem>
          </Link>

          <Link className="" to="/listtransaksi">
            <ListItem button >
              <ListItemIcon><ViewListIcon /> </ListItemIcon>
              <ListItemText>List Transactions</ListItemText>
            </ListItem>
          </Link>
...
> */}
      <Switch>
        ...
        {/* <Route path="/pesanmakan"></Route>
        <Route path="/listmakan"><MakananContainer /></Route>
        <Route path="/listminum"><MinumanContainer /></Route>
        <Route path="/bookmeja"><MejaContainer /></Route>
        <Route path="/listtransaksi"><TransaksiContainer /></Route> */}
        <Content/>
      </Switch>
        {/* </main> */}
    </Grid>
